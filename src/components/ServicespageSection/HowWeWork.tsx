    ...
    <div className='w-[100%] flex justify-center bg-[#f8f9fd] pb-[40px] pt-[35px]'>
        <div className='w-[90%] flex flex-col'>
            ...
            <div className='w-[100%] flex flex-wrap justify-between mt-[45px] ml-[12px]'>
                ...
                <div className='w-[45%] flex flex-col'>
                    <h3 className='text-[22px] font-[700] text-[#0A6618]'>Applied Research/Data Collection </h3>
                ...
                <div className='w-[45%] flex flex-col mt-[50px]'>
                    <h3 className='text-[22px] font-[700] text-[#A7284E]'>Feedback </h3>
                ...
                <div className='w-[45%] flex flex-col mt-[50px]'>
                    <h3 className='text-[22px] font-[700] text-[#0E2782]'>Implementation </h3>

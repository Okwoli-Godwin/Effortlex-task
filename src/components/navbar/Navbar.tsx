...
const Navbar = () => {
  ...
  return (
    <div className='w-[100%] h-[70px] flex items-center justify-center fixed bg-white z-20'>
        ...
        <div className={`fixed z-10 top-[70px] right-0 w-[100%] h-[100vh] bg-rgba ${show ? "translate-x-0" : "translate-x-full"}`}>
            <div className={`w-[50%] flex flex-col p-[15px] h-full bg-white fixed duration-500 ease-out right-0 transition-transform transform ${show ? "translate-x-0" : "translate-x-full"}`}>
                <h4 className='mb-[30px] text-[15px] cursor-pointer'><Link href="/">Home</Link></h4>
                <h4 className='mb-[30px] text-[15px] cursor-pointer'><Link href="/about">About</Link></h4>
                <h4 className='mb-[30px] text-[15px] cursor-pointer'><Link href="/service">Services</Link></h4>
                <h4 className='mb-[30px] text-[15px] cursor-pointer'><Link href="/blog">Blog</Link></h4>
                <Link href="/contact">

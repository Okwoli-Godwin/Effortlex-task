...
const Difference = () => {
  return (
    <div className='w-[100%] flex justify-center pb-[35px]'>
        <div className='w-[90%] bg-[#000000d0] mt-14  opacity-80  drop-shadow-lg p-16 pl-[30px] pr-[30px] pt-[35px] h-full max-lg:p-12 max-md:p-8 rounded-xl'>
            <h2 className='capitalize text-white font-bold text-3xl  text-center'>What makes us different...</h2>
            
            <div className='my-6 w-[62%] text-lg max-lg:w-[80%] max-md:w-full max-lg:text-base'>
            ...
            <div className='w-full mt-8 grid-cols-2 grid gap-5 max-lg:grid-cols-1 '>

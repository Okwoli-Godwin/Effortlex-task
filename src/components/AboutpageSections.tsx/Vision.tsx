...
const Vision = () => {
  return (
    <div className='w-[100%] flex justify-center bg-[#f8f9fd]'>
        <section className='p-16 pt-[40px] h-full max-lg:p-12 max-md:p-8 max-lg:mx-5 rounded-xl bg-[#dadaee] w-[90%] flex items-center pb-[35px] justify-between mb-[35px]'>
            <div className='w-[370px] h-[390px]'>
                  <Image src={img} alt='/' className='rounded-se-3xl rounded-bl-3xl object-cover w-full h-full'/>
            </div>
            
            <div className='w-[50%] flex flex-col'>
                <h2 className='text-primary text-[30px] font-[700]'>Vision</h2>
                <p className='mt-[20px]'>

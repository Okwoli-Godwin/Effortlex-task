...
const WhoWeAre = () => {
  return (
    <div className='w-[100%] h-[100%] flex justify-center bg-[#f8f9fd] mt-[45px] pt-[70px] sm:pt-[35px] pb-[70px]'>
        <div className='w-[90%] flex rounded-[10px] bg-[#E8E7FD] sm:bg-transparent p-[35px] sm:p-0 justify-between flex-wrap sm:flex-col-reverse'>
            <div className='w-[35%] md:w-[100%] sm:w-[100%] h-[430px] sm:h-[350px] md:h-[230px] rounded-tl-[15px] rounded-bl-[15px]'>
                <Image src={smilegirl} alt='/' className='w-[100%] h-[100%] object-cover'/>
            </div>

...
const Values = () => {
  return (
    <div className='w-[100%] h-[100%] bg-[#f8f9fd] flex justify-center pb-[70px]'>
        <div className='w-[90%] flex rounded-[10px] bg-[#E8E7FD] pt-[20px] flex-col items-center pl-[35px] pr-[35px] pb-[40px]'>
            <h2 className='text-[40px] sm:text-[25px] text-primary font-[700]'>
                OUR CORE VALUES
            </h2>
            <div className='w-[100%] flex flex-wrap mt-[20px] justify-center'>
                <div className='w-[45%] p-[20px] pt-[50px] pb-[50px] rounded-[10px] flex flex-col items-center bg-white mr-[100px] mb-[75px]'>
                ...
                <div className='w-[45%] p-[20px] pt-[50px] pb-[50px]  rounded-[10px] flex flex-col items-center bg-white mb-[75px]'>
                    <div className='w-[60px] h-[60px] rounded-[10px] bg-[#566599] flex justify-center items-center'>
                ...
                <div className='w-[45%] p-[20px] pt-[50px] pb-[50px] rounded-[10px] items-center flex flex-col bg-white mr-[100px] mb-[75px]'>
                    <div className='w-[60px] h-[60px] rounded-[10px] bg-[#566599] flex justify-center items-center'>
                ...
                <div className='w-[45%] p-[20px] pt-[50px] pb-[50px] rounded-[10px] items-center flex flex-col bg-white mb-[75px]'>
                    <div className='w-[60px] h-[60px] rounded-[10px] bg-[#566599] flex justify-center items-center'>
